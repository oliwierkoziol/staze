...
const ROCK1_TEXTURE: Texture2D = preload("res://turn-base-game/assets/mapTiles/rock1.png")
const ROCK2_TEXTURE: Texture2D = preload("res://turn-base-game/assets/mapTiles/rock2.png")
const ROCK2K_TEXTURE: Texture2D = preload("res://turn-base-game/assets/mapTiles/rock2k.png")
const ROCK3_TEXTURE: Texture2D = preload("res://turn-base-game/assets/mapTiles/rock3.png")
var KRZOK_TEXTURE: Texture2D = load("res://turn-base-game/assets/mapTiles/bush.png")
var ZIMOWY_KRZOK_TEXTURE: Texture2D = load("res://turn-base-game/assets/mapTiles/zimowykszok.png")
var VINES_TEXTURE: Texture2D = load("res://turn-base-game/assets/vines_bottom.png")
const WATER_TEXTURE: Texture2D = preload("res://turn-base-game/assets/mapTiles/water.png")
var QUICKSAND_TEXTURE: Texture2D = load("res://turn-base-game/assets/mapTiles/quicksand.png")
var DUNE_TEXTURE: Texture2D = load("res://turn-base-game/assets/mapTiles/dune.png")
var ICE_TEXTURE: Texture2D = load("res://turn-base-game/assets/mapTiles/ice.png")
const ICE_HEX_1_TEXTURE: Texture2D = preload("res://turn-base-game/assets/mapTiles/ice_hex_1.png")
const ICE_HEX_2_TEXTURE: Texture2D = preload("res://turn-base-game/assets/mapTiles/ice_hex_2.png")
const ICE_HEX_3_TEXTURE: Texture2D = preload("res://turn-base-game/assets/mapTiles/ice_hex_3.png")
var HOLY_TREE_TEXTURE: Texture2D = load("res://turn-base-game/assets/holy_tree.png")
var HOLY_TREE_LEFT_TEXTURE: Texture2D = load("res://turn-base-game/assets/mapTiles/holy_tree/holy_tree_left.png")
var HOLY_TREE_RIGHT_TEXTURE: Texture2D = load("res://turn-base-game/assets/mapTiles/holy_tree/holy_tree_right.png")
var HOLY_TREE_TOP_TEXTURE: Texture2D = load("res://turn-base-game/assets/mapTiles/holy_tree/holy_tree_top.png")
var HOLY_TREE_BOTTOM_TEXTURE: Texture2D = load("res://turn-base-game/assets/mapTiles/holy_tree/holy_tree_bottom.png")
var ELF_STATUE_TEXTURE: Texture2D = load("res://turn-base-game/assets/elfStatue.png")
var STATUE_LEFT_TEXTURE: Texture2D = load("res://turn-base-game/assets/mapTiles/statue/statue_left.png")
var STATUE_RIGHT_TEXTURE: Texture2D = load("res://turn-base-game/assets/mapTiles/statue/statue_right.png")
var STATUE_BOTTOM_TEXTURE: Texture2D = load("res://turn-base-game/assets/mapTiles/statue/statue_bottom.png")
var HOLE_TEXTURE: Texture2D = load("res://turn-base-game/assets/hole.png")
var HOLE_LEFT_TEXTURE: Texture2D = load("res://turn-base-game/assets/newAssets/holeLeft.png")
var HOLE_RIGHT_TEXTURE: Texture2D = load("res://turn-base-game/assets/newAssets/holeRight.png")
var CART_TEXTURE: Texture2D = load("res://turn-base-game/assets/cart.png")
var DETONATOR_TEXTURE: Texture2D = load("res://turn-base-game/assets/detonator.png")
const UnitTypeLibraryScript = preload("res://turn-base-game/scripts/unit_type_library.gd")
const GEORGIA_FONT: Font = preload("res://turn-base-game/theme/georgia.ttf")
const SHIELD_TEXTURE: Texture2D = preload("res://turn-base-game/assets/ui/energy_shield.png")
...
var TRAP_TEXTURE: Texture2D = load("res://turn-base-game/assets/trap-removebg-preview.png")
var MAGIC_PROJECTION_TEXTURE: Texture2D = load("res://turn-base-game/assets/magic_projection.png")
