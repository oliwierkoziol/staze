...
const STRONY_TUTORIALA: Array = [
	[
		"Witaj w trybie Potyczka!",
		"",
		"Wybierz gotowy scenariusz albo skonfiguruj własne armie w trybie Własna bitwa.",
		"Ustawienie sterowania przeciwnikiem zmienia zachowanie komputera albo włącza grę lokalną.",
		"Przycisk WCZYTAJ STAN WALKI w menu Potyczki przywraca zapisaną bitwę.",
	...
	[
		...
		"Zapis, wczytanie, reset walki i powrót do menu Potyczki znajdziesz w menu pauzy pod Esc.",
	...
	[
		"Aktywna jednostka ma ograniczony Zasięg Ruchu i Punkty Akcji (PA) na swoją aktywację.",
		"",
		...
		"Użycie umiejętności może kosztować PA i uruchamia cooldown liczony w aktywacjach tej jednostki.",
	],
	[
	...
	[
		...
		"",
		"Kliknij ZAKOŃCZ AKTYWACJĘ lub naciśnij Spację, gdy skończysz działać aktywną jednostką.",
		"Bitwę wygrywa strona, która jako pierwsza zniszczy wszystkie wrogie jednostki.",
		"Tab otwiera pełną pomoc, a Esc menu pauzy.",
	],
]
...
const SEKCJE_POMOCY: Array[Dictionary] = [
	{
		...
		"lines": [
			...
			"Spacja — rozpocznij bitwę albo zakończ aktywację jednostki.",
			"Esc — otwórz lub zamknij menu pauzy.",
			...
			"ZAKOŃCZ AKTYWACJĘ — kończy działania aktywnej jednostki i przekazuje inicjatywę dalej.",
	...
	},
	{
		"title": "ROZGRYWKA",
		"lines": [
			"Tryby — scenariusze oferują gotowe bitwy, a Własna bitwa pozwala wybrać frakcje i liczebność armii.",
			...
			"Aktywacja jednostki — każda jednostka ma Punkty Akcji (PA) i Zasięg Ruchu.",
			...
			"Umiejętności — do 3 umiejętności aktywnych lub biernych; aktywne mogą kosztować PA i mają cooldown w aktywacjach.",
	...
	},
	{
		...
		"lines": [
			...
			"Prawy panel — generał, jego umiejętności, log bitwy i przycisk rozpoczęcia lub zakończenia aktywacji.",
